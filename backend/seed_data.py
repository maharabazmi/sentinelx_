...
def get_seed_records():
    ...
    users = [
        ...
        User(
            id="user-pol-5",
            nidNumber="1849204888",
            fullName="SI Rahman Hossain",
            email="police.rahman@dmp.gov.bd",
            phone="+8801713004433",
            role="POLICE",
            badgeNumber="DMP-77310",
            designation="Sub-Inspector",
            department="Dhaka Metropolitan Police - Crime Division",
            stationOrThana="Dhanmondi Police Station, Dhaka",
            isNIDVerified=True,
            createdAt=(now - timedelta(days=88)).isoformat(),
            passwordHash=default_hash,
        ),
        User(
            id="user-cr-1",
        ...
        User(
            id="user-cr-2",
            nidNumber="3948102949",
            fullName="Tariqul Islam",
            email="tariqul.investigator@dncrp.gov.bd",
            phone="+8801712884434",
            role="CONSUMER_RIGHTS",
            badgeNumber="DNCRP-OFFICER-45",
            designation="Investigation Officer",
            department="Directorate of National Consumers Right Protection (DNCRP)",
            stationOrThana="Dhaka Central Directorate",
            assignedDistrict="Dhaka",
            isNIDVerified=True,
            createdAt=(now - timedelta(days=85)).isoformat(),
            passwordHash=default_hash,
        ),
        User(
            id="user-cr-3",
            nidNumber="3948102950",
            fullName="Nasreen Akter",
            email="nasreen.adjudicator@dncrp.gov.bd",
            phone="+8801712884435",
            role="CONSUMER_RIGHTS",
            badgeNumber="DNCRP-OFFICER-46",
    ...
    complaints = [
        ...
        ConsumerComplaint(
            id="comp-005",
            trackingNumber="DNCRP-DHK-2026-3829",
            complainantId="user-cit-1",
            complainantName="Tanvir Hossain",
            complainantPhone="+8801711234567",
            shopName="Bengal Sweets & Bakery",
            shopAddress="Elephant Road, Dhaka",
            shopDistrict="Dhaka",
            shopThana="Dhanmondi",
            tradeLicenseOrBIN="BIN-44582910",
            productName="Premium Sweetmeat Box (1 Kg)",
            brandName="Bengal Sweets",
            barcode="8901199228833",
            issueType="WEIGHT_MEASUREMENT_FRAUD",
            pricePaid=750.0,
            mrp=750.0,
            description="Sweetmeat box weighed 780g net instead of the paid 1000g. Heavy packaging counted as net weight.",
            submittedAt=(now - timedelta(days=2)).isoformat(),
            status="INVESTIGATION_SUMMARY",
            workflowQueue="ADJUDICATION",
            evidence=[],
            investigationSummary="Physical digital scale inspection confirmed 220g deficit per package across 15 boxes. Summoned merchant manager.",
            inspectorNotes="Investigation confirmed fraudulent measurement packaging.",
            assignedOfficerName="Nasreen Akter",
            assignedOfficerId="user-cr-3",
            timeline=[
